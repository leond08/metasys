...
<ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a href="#"><i class="fa fa-edit"></i> Contestants <small class="label pull-right bg-green">new</small></a>
				<ul class="treeview-menu">
              ...
              <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <tr>
                      <td>183</td>
                      <td><img src="dist/img/logo.png" width="30" height="30" class="img-circle"></img></td>
                      <td>John Doe</td>
                      <td><span class="label label-success">Active</span></td>
                      <td><button class="btn btn-box-tool" data-widget="remove" id="remove-crit"><i class="fa fa-remove"></i></button>
					<button class="btn btn-box-tool"  id="edit-crit"><i class="fa fa-edit"></i></button>
					</td>
                    </tr>
                    <tr>
                      <td>219</td>
                      <td><img src="dist/img/logo.png" width="30" height="30" class="img-circle"></td>
                      <td>Alexander Pacer</td>
