...
<ul class="sidebar-menu">
            ...
            <li class="active treeview">
             ...
             <ul class="treeview-menu">
                ...
                <li class="active"><a href="judge.php"><i class="fa fa-edit"></i> Judges <small class="label pull-right bg-green">new</small></a>
				<ul class="treeview-menu">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
			...
			<li class="active">List of Judges</li>
          </ol>
        </section>
		 ...
		 <!-- SELECT -->
              ...
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">List of Judges</h3> 
			  <div class="box-tools pull-right">
                ...
                <div class="box-body">
                  ...
                  <table class="table table-bordered">
                    ...
                    <select class="form-control select2"  data-placeholder="Select designation" style="width: 100%;" name="segment_criteria[]">
                      <option></option>
