...
$connect = db_connect();
	...
	$query = "Select event_name,event_image from event where event_name = '".$_SESSION['e']."' LIMIT 1";
...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
   ...
   $(function(){
	   ...
	   function addSegment(){
			$('.appendbox').append('<div class="box box-info" id="box"><div class="box-header with-border"> <h3 class="box-title"></h3><div class="box-tools pull-right"><button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button><button class="btn btn-box-tool" data-widget="remove" id="remove"><i class="fa fa-remove"></i></button> </div></div><div class="box-body"><div class="row"><div class="col-md-6"><div class="form-group"><label>Segment Name</label><input type="text" class="form-control" placeholder="Enter a judge name" name="segment_name[]"></div></div><div class="col-md-6"><div class="form-group"><label>Percentage</label><div class="input-group"><div class="input-group-addon"><i class="fa fa-laptop"></i></div><input type="number" class="form-control" min="1" max="100" name="segment_percentage[]" id="segment_percentage"></div></div></div><div class="col-md-6"><div class="form-group"><label>Select Criteria</label><select class="form-control select2" multiple="multiple" data-placeholder="Select designation" style="width: 100%;" name="segment_criteria[]"><option></option><option>Beauty</option><option>Poise</option><option>BeautyandPoise</option><option>Intelligent</option></select></div></div></div></div></div>');
            ...
            <ul class="nav navbar-nav">
                    ...
                    <ul class="menu">
                      <li><!-- start message -->
                        <a href="#">
                          <div class="pull-left">
                            <!-- User Image -->
                            <img src="upload_image/<?php echo $image;?>" class="img-circle" alt="User Image">
                          </div>
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <img src="upload_image/<?php echo $image;?>" class="user-image" alt="User Image">
...
<ul class="sidebar-menu">
            ...
            <li class="active treeview">
             ...
             <ul class="treeview-menu">
                <li class="active"><a href="#"><i class="fa fa-edit"></i>Segment<small class="label pull-right bg-green">new</small></a>
				<ul class="treeview-menu">
				 <li class="active"><a href="segment_table.php"><i class="fa fa-edit"></i>View Segment</a></li>
				...
				<li><a href="scoring.php"><i class="fa fa-edit"></i> Scoring <small class="label pull-right bg-green">new</small></a>
				<ul class="treeview-menu">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
			...
			<li class="active">Add segment</li>
          </ol>
        </section>
              ...
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Production Performance </h3>&nbsp;&nbsp;
				   <h3 class="box-title"><input type="number" class="form-control" min="1" max="100" value="" name="segment_percentage[]" id="segment_percentage"></h3>
				   
			  <div class="box-tools pull-right">
				
                <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                <button class="btn btn-box-tool" data-widget="remove" id="remove"><i class="fa fa-remove"></i></button>
              </div>
                </div><!-- /.box-header -->
                <div class="box-body">
