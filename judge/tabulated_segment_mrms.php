                   ...
                   <table id="event_table" class="table no-margin table-hover text-center">
					...
					<?php 
							...
							$r=db_res_to_array($res);
								...
								$rank_tie = array();
								$num = 1;
									$rank = _sqlRetrieve_param("a.con_id as con_id,a.segment_id as segment_id,a.judge_id as judge_id","score as a,individual_contestant as b","a.event_id",$_SESSION['event_id'],"AND judge_id = '".$c['judge_id']."' AND segment_id = '".$seg."' AND b.con_id = a.con_id AND b.type = 'Mr' order BY score desc");
					...
					<?php 
					 ...
					 $t =  _sqlRetrieve_param2("a.segment_id as segment_id,a.con_id as con_id,b.fname as fname,b.mi as mi,b.lname as lname,b.number as number,b.image_name as image","score as a,individual_contestant as b","a.event_id",$_SESSION['event_id'],"AND a.segment_id = '$seg' AND a.con_id = b.con_id AND b.type = 'Mr' GROUP BY a.con_id");
				  ...
				  <div class="table-responsive">
					...
					<?php 
							...
							$r=db_res_to_array($res);
								...
								$rank_tie = array();
								$num = 1;
									$rank = _sqlRetrieve_param("a.con_id as con_id,a.segment_id as segment_id,a.judge_id as judge_id","score as a,individual_contestant as b","a.event_id",$_SESSION['event_id'],"AND judge_id = '".$c['judge_id']."' AND segment_id = '".$seg."' AND b.con_id = a.con_id AND b.type = 'Ms' order BY score desc");
									$dbrank = db_res_to_array($rank);
				  ...
				  <div class="table-responsive">
                   ...
                   <thead>
					...
					<?php $res = _sqlRetrieve_param("DISTINCT a.segment_id as seg_id,b.percentage as percentage,b.name as name","score as a,segment as b","a.event_id",$_SESSION['event_id'],"AND b.segment_id = a.segment_id");
					 ...
					 <!-- loop contestant details -->
					<?php 
					  $t = _sqlRetrieve_param2("sum(a.rank) as score,a.segment_id as segment_id,a.con_id as con_id,b.fname as fname,b.mi as mi,b.lname as lname,b.number as number,b.image_name as image","score as a,individual_contestant as b","a.event_id",$_SESSION['event_id'],"AND a.con_id = b.con_id AND b.type = 'Ms' GROUP BY a.con_id ORDER BY sum(a.rank)");
