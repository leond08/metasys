...
<html>
		 ...
		 <div class="overlayer"></div>
			...
			<input type="hidden" name="action" value="formsubmit">
                ...
                <div class="box-body table-responsive">
                  <table class="table table-hover">
                    <tr>
                      ...
                      <th>Image</th>
                      <th>Name</th>
					  <?php if($q['allow_segment'] == 'yes'):
						 $ii = "segment_id";
						 $qu = _sqlQuerySelectAll("criteria","segment_id",$id);
					...
					<tr>
					 ...
					 if(!mysqli_num_rows($res) <= 0):
						for($i = 1;$i<=$count=_sqlLast_insert("count(criteria_id)","criteria","$ii",$id);$i++):?>
				...
				<div class="box-footer" align="right">
					<a href="controller_score.php?action=score" class="btn btn-flat btn-primary">Back</a>
  ...
  $("[data-slider]")
	...
	$('#formsubmit').submit(function(event){
		...
		$.ajax({
			url: 'controller_score.php?action=score_segment',
			type: 'POST',
			success: function(d){
				//alert(d);
				self.location = "controller_score.php?action=score";
			},
			data: formData,
