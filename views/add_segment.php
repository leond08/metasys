                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <label>Segment Name</label>
					     ...
					     <input type="text" class="form-control" placeholder="Enter segment name" name="segment_name" id="segment_name">
                  </div><!-- /.form-group -->
                </div><!-- /.col -->
			    <div class="col-md-6">
					 <div class="form-group">
	...
	$(function(){
		...
		$('#btn_submit').click(function(){
				...
				if($('#segment_name').val() == ''){
				    ...
				    var par = $('#segment_name').parents('.form-group').first();
				...
				if($('#segment_name').val() != '' && typeof(attr) === undefined || typeof(attr) === 'undefined'){
				var ajax = new XMLHttpRequest();
			    
				ajax.open("GET","controller.php?action=create_segment",true);
				ajax.onreadystatechange = function(){
					...
					if(selectdata() != '' && $('#segment_name').val() != ''){
						if(bool){
						_sendData();
						_clearData();
						} 
							...
							var par = $('#segment_criteria').parents('.form-group');
							par.addClass('has-error');
					}
					}
	...
	function _sendData(){
		...
		ajax.onreadystatechange = function(){
		 ...
		 var unique_id = $.gritter.add({
            ...
            title: name+' segment has been added..',
