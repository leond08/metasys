   ...
   <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
		 ...
		 if($ret['id'] == 0):
				updateAll("event","is_show = 'NO'","WHERE event_id = '".$_SESSION['eid']."'");
		 ?>
			...
			<?php else:?>
		       <div class="nav-tabs-custom">
				...
				------------------------------>
				 ...
				 <?php $res = _sqlRetrieve_param(" DISTINCT a.criteria_id as crit_id,b.percentage as percentage,b.name as name","score as a,criteria as b","a.event_id",$_SESSION['eid'],"AND b.criteria_id = a.criteria_id");
							...
							$r=db_res_to_array($res);
								...
								$num = 1;
								 if($cat == 'Group' || $cat == 'group'){
									$rank = _sqlRetrieve_param("a.group_id as con_id,a.criteria_id as criteria_id,a.judge_id as judge_id","score as a,group_contestant as b","a.event_id",$_SESSION['eid'],"AND judge_id = '".$c['judge_id']."' AND criteria_id = '".$seg."' AND b.group_id = a.group_id ORDER BY score DESC ");
									}else{
										$rank = _sqlRetrieve_param("score,a.con_id as con_id,a.criteria_id as criteria_id,a.judge_id as judge_id","score as a,individual_contestant as b","a.event_id",$_SESSION['eid'],"AND judge_id = '".$c['judge_id']."' AND criteria_id = '".$seg."' AND b.con_id = a.con_id ORDER BY score DESC ");
									}
					 ...
					 <!-- /.end of loop contestant details -->
					  ...
					  endforeach;?>
						...
						<div class="box-footer pull-right">
						  <a href="print-tabulated-all-criteria.php?event_id=<?php echo $_SESSION['eid'];?>&seg_id=<?php echo $seg;?>&type=<?php echo $cat;?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
					...
					<?php 
					 ...
					 <!-- /.end of loop contestant details -->
					  ...
					  endforeach;?>
						...
						<div class="box-footer pull-right">
						  <a href="print-tabulated-all-criteria-con.php?event_id=<?php echo $_SESSION['eid'];?>&type=<?php echo $cat;?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
