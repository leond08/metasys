		       ...
		       <div class="nav-tabs-custom">
				...
				<div class="box-body">
				  ...
				  <div class="table-responsive">
							...
							$r=db_res_to_array($res);
								...
								$num = 1;
								 if($cat == 'Group' || $cat == 'group'){
									$rank = _sqlRetrieve_param("a.group_id as con_id,a.segment_id as segment_id,a.judge_id as judge_id","score as a,group_contestant as b","a.event_id",$_SESSION['eid'],"AND judge_id = '".$c['judge_id']."' AND segment_id = '".$seg."' AND b.group_id = a.group_id ORDER BY score DESC ");
									}else{
										$rank = _sqlRetrieve_param("score,a.con_id as con_id,a.segment_id as segment_id,a.judge_id as judge_id","score as a,individual_contestant as b","a.event_id",$_SESSION['eid'],"AND judge_id = '".$c['judge_id']."' AND segment_id = '".$seg."' AND b.con_id = a.con_id ORDER BY score DESC ");
									}
					...
					<?php 
					   if($cat == 'Group' || $cat == 'group'){
					 $t = _sqlRetrieve_param("group_id","score","event_id",$_SESSION['eid'],"AND segment_id = '$seg' GROUP BY group_id");
					 }else{
						$t =  _sqlRetrieve_param("con_id","score","event_id",$_SESSION['eid'],"AND segment_id = '$seg' GROUP BY con_id");
					 }
					  $tie = array();
					  $count = 1;
					  $t = db_res_to_array($t);
					 ...
					 <tr>
						...
						<?php
							...
							//echo $seg;
							 ...
							 if($cat == 'Group' || $cat == 'group'){
								$score_this =  _sqlRetrieve_param("score,rank,group_id","score","event_id",$_SESSION['eid'],"AND segment_id = '$seg' AND group_id = '$cid' "); 
							}else{
					 ...
					 <!-- /.end of loop contestant details -->
					  ...
					  endforeach;?>
						...
						<div class="box-footer pull-right">
						  <a href="print-tabulated-all-segment.php?event_id=<?php echo $_SESSION['eid'];?>&seg_id=<?php echo $seg;?>&type=<?php echo $cat;?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
				...
				/------------------------>
				  ...
				  <div class="table-responsive">
                   <table id="event_table" class="table no-margin table-hover text-center">
					...
					<?php 
					   if($cat == 'Group' || $cat == 'group'){
					 $t =  _sqlRetrieve_param("sum(score),group_id","score","event_id",$_SESSION['eid'],"GROUP BY group_id order by sum(score)");
					 }else{
						$t = _sqlRetrieve_param("sum(score),con_id","score","event_id",$_SESSION['eid'],"GROUP BY con_id order by sum(score)");
					 }
					  $tie = array();
					  $count = 1;
					   foreach($t as $d):
					 ...
					 <!-- /.end of loop contestant details -->
					  ...
					  endforeach;?>
						...
						<div class="box-footer pull-right">
						  <a href="print-tabulated-all-cont.php?event_id=<?php echo $_SESSION['eid'];?>&type=<?php echo $cat;?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i>Print</a>
						</div>
                </div><!-- /.box-body -->
                  </div><!-- /.tab-pane -->
                </div><!-- /.tab-content -->
