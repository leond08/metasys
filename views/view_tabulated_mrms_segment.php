                   ...
                   <table id="event_table" class="table no-margin table-hover text-center">
					...
					<?php 
							...
							$r=db_res_to_array($res);
								...
								$rank_tie = array();
								$num = 1;
									$rank = _sqlRetrieve_param("a.con_id as con_id,a.segment_id as segment_id,a.judge_id as judge_id","score as a,individual_contestant as b","a.event_id",$_SESSION['eid'],"AND judge_id = '".$c['judge_id']."' AND segment_id = '".$seg."' AND b.con_id = a.con_id AND b.type = 'Mr' order BY score desc");
					...
					<?php 
					 ...
					 $t =  _sqlRetrieve_param2("a.segment_id as segment_id,a.con_id as con_id,b.fname as fname,b.mi as mi,b.lname as lname,b.number as number,b.image_name as image","score as a,individual_contestant as b","a.event_id",$_SESSION['eid'],"AND a.segment_id = '$seg' AND a.con_id = b.con_id AND b.type = 'Mr' GROUP BY a.con_id");
					 ...
					 <!-- /.end of loop contestant details -->
					  ...
					  endforeach;?>
						...
						<div class="box-footer pull-right">
						  <a href="print-tabulated-mrms.php?event_id=<?php echo $_SESSION['eid'];?>&seg_id=<?php echo $seg;?>&type=Mr" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
				  ...
				  <div class="table-responsive">
					...
					<?php 
							...
							$r=db_res_to_array($res);
								...
								$rank_tie = array();
								$num = 1;
									$rank = _sqlRetrieve_param("a.con_id as con_id,a.segment_id as segment_id,a.judge_id as judge_id","score as a,individual_contestant as b","a.event_id",$_SESSION['eid'],"AND judge_id = '".$c['judge_id']."' AND segment_id = '".$seg."' AND b.con_id = a.con_id AND b.type = 'Ms' order BY score desc");
									$dbrank = db_res_to_array($rank);
					...
					<?php 
					 ...
					 <tr>
						...
						<?php
							...
							<!-- first loop for segment 1 -->
						  <td class="rank_i"><?php echo $score['rank'];?></td>
						   <td class="score_i"><?php echo number_format($score['score'],2);?></td>
						  <?php endforeach;?>
					    <!-- /.judge score for segment 1 -->
						<!-- end of loop judge score for segment 1 -->
					 ...
					 <!-- /.end of loop contestant details -->
					  ...
					  endforeach;?>
						...
						<div class="box-footer pull-right">
						  <a href="print-tabulated-mrms.php?event_id=<?php echo $_SESSION['eid'];?>&seg_id=<?php echo $seg;?>&type=Ms" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
				 ...
				 <div class="tab-pane" id="tab_2">
				  ...
				  <div class="table-responsive">
					...
					<?php $res = _sqlRetrieve_param("DISTINCT a.segment_id as seg_id,b.percentage as percentage,b.name as name","score as a,segment as b","a.event_id",$_SESSION['eid'],"AND b.segment_id = a.segment_id");
					 ...
					 <!-- loop contestant details -->
					<?php 
					  $t = _sqlRetrieve_param2("sum(a.rank) as score,a.segment_id as segment_id,a.con_id as con_id,b.fname as fname,b.mi as mi,b.lname as lname,b.number as number,b.image_name as image","score as a,individual_contestant as b","a.event_id",$_SESSION['eid']," AND a.con_id = b.con_id AND b.type = 'Mr' GROUP BY a.con_id ORDER BY sum(a.score) DESC");
					 ...
					 <!-- /.end of loop contestant details -->
					  ...
					  endforeach;?>
						...
						<div class="box-footer pull-right">
						  <a href="print-tabulated-all-mrms.php?event_id=<?php echo $_SESSION['eid'];?>&type=Mr" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
					...
					<?php 
					 ...
					 <!-- /.end of loop contestant details -->
					  ...
					  endforeach;?>
						...
						<div class="box-footer pull-right">
						  <a href="print-tabulated-all-mrms.php?event_id=<?php echo $_SESSION['eid'];?>&type=Ms" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
