      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
			...
			<li class="active">Update Scoring</li>
          </ol>
        </section>

        <!-- Main content -->
		 <?php $ret = _sqlRetrieve_num("max_score,min_score,interval_score","event","event_id",$_SESSION['eid']);
		 $sc = mysqli_fetch_assoc($ret);
		 ?>
          ...
          <!-- Your Page Content Here -->
			  <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Update Scoring</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <label for="rangeMin">Range</label>
                       <input type="number" class="form-control" min="1" max="10" value="<?php echo $sc['min_score'];?>" name="min_score" id="min_score" placeholder="min" >
                    </div>
                    <div class="form-group">
                      <label for="rangeMax">To</label>
                      <input type="number" class="form-control" min="1" max="10" value="<?php echo $sc['max_score'];?>" name="max_score" id="max_score" placeholder="max" >
                    </div>
				    <div class="form-group">
                      <label for="venue">Interval</label>
                       <select class="form-control" id="score_interval" name="score_interval">
					    <option value="0.1" <?php if($sc['interval_score'] == '0.1'){echo 'selected';}?>>0.1</option>
                        <option value="0.5" <?php if($sc['interval_score'] == '0.5'){echo 'selected';}?>>0.5</option>
                        <option value="1" <?php if($sc['interval_score'] == '1'){echo 'selected';}?>>1</option>
                      </select>
                    </div>
					<!--
					<div class="form-group">
                  ...
                  <div class="box-footer">
                    <button type="reset" class="btn btn-primary">Reset</button>
					 <button type="submit" class="btn btn-primary" id="btn_submit">Save
                  </div>
                </form>
              </div><!-- /.box -->
