          ...
          <div class="col-xs-12 table-responsive">
            <table class="table table-striped text-center">
					...
					<?php 
					 ...
					 $t =  _sqlRetrieve_param2("a.segment_id as segment_id,a.con_id as con_id,b.fname as fname,b.mi as mi,b.lname as lname,b.number as number,b.image_name as image","score as a,individual_contestant as b","a.event_id",$_SESSION['eid'],"AND a.segment_id = '$seg' AND a.con_id = b.con_id AND b.type = '".$cat."' GROUP BY a.con_id ");
