    ...
    <div class="wrapper">
      ...
      <section class="invoice">
		...
		<?php 
					    ...
					    $j = _sqlQuerySelectLast("segment","segment_id",$seg);
						  $segment = $j['name'];
          ...
          <div class="col-xs-12 table-responsive">
            <table class="table table-striped text-center">
					...
					<?php 
					 ...
					 $t = _sqlRetrieve_param("sum(rank),group_id","score","event_id",$_SESSION['eid'],"AND segment_id = '$seg' GROUP BY group_id order by sum(rank) ");
					 }else{
						$t =  _sqlRetrieve_param("sum(rank),con_id","score","event_id",$_SESSION['eid'],"AND segment_id = '$seg' GROUP BY con_id order by sum(rank)  ");
					 }
					  $tie = array();
					  $count = 1;
					  $t = db_res_to_array($t);
					 ...
					 <tr>
						...
						<?php
							...
							//echo $seg;
							 ...
							 if($cat == 'Group' || $cat == 'group'){
								$score_this =  _sqlRetrieve_param("rank,group_id","score","event_id",$_SESSION['eid'],"AND segment_id = '$seg' AND group_id = '$cid' "); 
							}else{
									$score_this =  _sqlRetrieve_param("rank,con_id","score","event_id",$_SESSION['eid'],"AND segment_id = '$seg' AND con_id = '$cid' "); 
